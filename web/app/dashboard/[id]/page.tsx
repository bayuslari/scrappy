      ...
      <div className="mt-3 grid gap-4 md:grid-cols-[1fr_280px]">
        <div>
          <div className="rounded-xl border border-slate-200 bg-white p-5">
            ...
            {job.tech_hits && (
              <p className="mt-2 text-xs text-slate-400">{job.tech_hits}</p>
            )}
            ...
            {job.url && (
              <a
                ...
                className="mt-4 inline-flex rounded-lg bg-slate-900 px-3 py-1.5 text-sm font-medium text-white hover:bg-slate-700"
              >
